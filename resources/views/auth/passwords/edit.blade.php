            ...
            <div class="card-body">
                <form action="{{ route('password.update') }}" method="POST">
                    ...
                    <div class="d-grid d-sm-flex justify-content-sm-end gap-2">
                        <button type="submit" class="btn btn-primary order-sm-2"><i class="ti ti-device-floppy me-1"></i>Simpan Perubahan</button>
                        <a href="{{ url('/dashboard') }}" class="btn btn-light order-sm-1">Batal</a>
                    </div>
                </form>
            </div>
        </div>
